...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return InfoTrack; });
...
/*#__PURE__*/
function () {
  function InfoTrack(access_token) {
    _classCallCheck(this, InfoTrack);
  ...
  _createClass(InfoTrack, [{
    key: "render",
    value: function render() {
      var auth = new _auth__WEBPACK_IMPORTED_MODULE_0__["default"]();
      var hash = auth.getHashParams();
      console.log(hash.access_token);
      jquery__WEBPACK_IMPORTED_MODULE_1___default()('.container').html(this.corps);
      jquery__WEBPACK_IMPORTED_MODULE_1___default()('.retour').click(function () {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_1___default.a.ajax({
        ...
        success: function success(data) {
          ...
          console.log("<img src=\"".concat(data['item']['album'].images[1].url, "\">"));
          jquery__WEBPACK_IMPORTED_MODULE_1___default()('.title').html(data['item'].name);
          jquery__WEBPACK_IMPORTED_MODULE_1___default()('.image').html("<img src=\"".concat(data['item']['album'].images[1].url, "\">"));
          jquery__WEBPACK_IMPORTED_MODULE_1___default()('.album').html("<td>album</td><td>".concat(data['item']['album'].name, "</td>"));
          jquery__WEBPACK_IMPORTED_MODULE_1___default()('.artist').html("<td>artist</td><td>".concat(data['item'].artists[0].name, "</td>"));
        }
      });
    }
  }]);
  ...
  _createClass(Profil, [{
    ...
    value: function render() {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_2___default.a.ajax({
        url: "https://api.spotify.com/authorize?client_id=".concat(auth.client_id, "&response_type=code&redirect_uri=").concat(auth.redirect_uri, "&scope=user-read-private%20user-read-email&state=34fFs29kd09"),
        type: 'GET'
      });
      jquery__WEBPACK_IMPORTED_MODULE_2___default.a.ajax({
      ...
      jquery__WEBPACK_IMPORTED_MODULE_2___default()('.play').click(function (data) {
        jquery__WEBPACK_IMPORTED_MODULE_2___default.a.ajax({
      ...
      jquery__WEBPACK_IMPORTED_MODULE_2___default.a.ajax({
        ...
        success: function success(data) {
          ...
          jquery__WEBPACK_IMPORTED_MODULE_2___default()('.info').click(function (data) {
            ...
            info.render(_this2.access_token);
            return false;
          });
        }
      });
...
/* harmony import */ var _Auth_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Auth.js */ "./js/Auth.js");
/* harmony import */ var _InfoTrack_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./InfoTrack.js */ "./js/InfoTrack.js");
/* harmony import */ var _Profil_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Profil.js */ "./js/Profil.js");




var auth = new _Auth_js__WEBPACK_IMPORTED_MODULE_1__["default"]();
...
if (hash.access_token === undefined) {
  ...
  var profil = new _Profil_js__WEBPACK_IMPORTED_MODULE_3__["default"]();
  profil.render();
}
/*function $_GET(param) {
    var vars = {};
